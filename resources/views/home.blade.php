...
@section('content')
 ...
 <h3 class="widget-user-username text-center">Kim Taehyung</h3>
 <h5 class="widget-user-desc text-center">BTS financial management</h5>
 </div>
 ...
 <div class="card card-widget widget-user">
 <div class="widget-user-header text-white" style="background: url('gambar/bg.jpg') center center; background-size:cover;">
 <h3 class="widget-user-username text-center">Kim Seokjin</h3>
 <h5 class="widget-user-desc text-center">BTS financial management</h5>
 </div>
 <div class="widget-user-image">
