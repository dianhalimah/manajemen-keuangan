...
<div class="form-group">
 <label for="sumber_pemasukan" class="col-sm-2 control-label">Sumber Pemasukan</label>
 <div class="col-sm-3">
 <input type="text" name="sumber_pemasukan" id="sumber_pemasukan" class="form-control" value="{{ $sumber_pemasukan ?? '' }}" >
 </div>
</div>
...
<div class="form-group">
 ...
 <a href="{{ route('pemasukan.index') }}" class="btn btn-primary" role="button">Batal</a>
 </div>
</div>